<template>
    <div class="bg-cyan-950 h-screen pt-5">
        <div class=" flex flex-col">
            <button id="show-modal" @click="handleCreateClick" type="button"
                class="bg-green-600 rounded-xl w-40 px-3 py-1 text-sm m-auto mb-5">Create</button>
            <Teleport to="body">
                <!-- use the modal component, pass in the prop -->
                <CreateModal :show="showCreateModal" @close="showCreateModal = false"
                    @project-submitted="handleProjectSubmitted" @cancel-button-clicked="showCreateModal = false">
                    <template #header>
            ...
            <div v-for="project in projects" class="mb-4 mx-20">
