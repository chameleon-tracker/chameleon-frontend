<template>
    <form @submit.prevent="onSubmit">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input v-model="title" type="text" name="title" id="title" autocomplete="title"
                    ...
                    <div class="col-span-full">
                        <label for="description"
                            class="block text-sm font-medium leading-6 text-green-500">Description</label>
                        <div class="mt-2">
                    ...
                    <div class="sm:col-span-3">
                        <label for="description_markup"
                            class="block text-sm font-medium leading-6 text-blue-500">Markup</label>
                        <div class="mt-2">
                            <select v-model="description_markup" id="description_markup" name="description_markup"
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <button type="button" class="text-sm font-semibold leading-6 text-white" @click="onCancel">Cancel</button>
            <button type="submit"
                class="rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create</button>
        </div>
    </form>
</template>
